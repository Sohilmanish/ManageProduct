		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commanishmanageproduct-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commanishmanageproduct-display": {
								"semanticObject": "commanishmanageproduct",
								"action": "display",
								"description": "manage product application",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.manish.manageproduct",
									"url": sap.ui.require.toUrl("com/manish/manageproduct")
								}
							}
						}
					}
